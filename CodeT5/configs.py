...
from utils import get_src_tgt_lang
...
def add_args(parser):
    ...
    parser.add_argument("--apply_lora_ff", action="store_true",
                        help="Apply FF LoRA")
    parser.add_argument("--lora_ff_alpha", type=int, default=None,
                        help="scaling coefficient in FF LoRA")
    parser.add_argument("--lora_ff_r", type=int, default=None,
    ...
    parser.add_argument("--adapter_type", type=str, choices=['houlsby', ''], default='',
                        help="Adapter type")
    parser.add_argument("--adapter_size", type=int, default=None,
    ...
    # Misc
    parser.add_argument("--wandb_project", type=str, default='code-lora',
                        help="WandB project name")
    parser.add_argument("--log_step", type=str, default=100,
    ...
    Path(args.res_dir).absolute().resolve().mkdir(parents=True, exist_ok=True)
    if args.res_fn != "":
    ...
    args.src_lang, args.tgt_lang = get_src_tgt_lang(args.task, args.sub_task, 'base')
