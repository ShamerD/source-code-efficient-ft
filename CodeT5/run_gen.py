...
from utils import get_filenames, get_elapse_time, load_and_cache_gen_data, WanDBWriter
    ...
    for batch in tqdm(eval_dataloader, total=len(eval_dataloader), desc="Eval bleu for {} set".format(split_tag)):
        ...
        with torch.no_grad():
            if args.model_type == 'roberta':
                ...
                start_token = (tokenizer.lang_code_to_id[args.tgt_lang]
    ...
    if args.do_train:
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            if args.do_eval:
                ...
                logger.info("  " + "*" * 20)
                if args.data_num == -1:
                    log_writer.set_step((cur_epoch + 1) * len(train_dataloader), 'dev')
                    log_writer.add_scalar('ppl', eval_ppl)
                ...
                if args.do_eval_bleu:
                    ...
                    if args.data_num == -1:
                        ...
                        log_writer.add_scalar('bleu_em', dev_bleu_em)
