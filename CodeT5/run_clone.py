...
from utils import get_filenames, get_elapse_time, load_and_cache_clone_data, WanDBWriter, mark_trainable
...
def main():
    ...
    config = config_class.from_pretrained(args.config_name if args.config_name else args.model_name_or_path,
                                          ...
                                          lora_r=args.lora_r,
                                          apply_lora_ff=args.apply_lora_ff,
                                          lora_ff_alpha=args.lora_ff_alpha,
                                          lora_ff_r=args.lora_ff_r,
    ...
    model = mark_trainable(args, model)
    ...
    if args.do_train:
        ...
        if args.local_rank in [-1, 0] and args.data_num == -1:
            ...
            log_writer = WanDBWriter(args, dir=summary_fn)
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(bar):
                ...
                if nb_tr_steps % args.gradient_accumulation_steps == 0:
                    ...
                    if nb_tr_steps % args.log_step == 0:
                        log_writer.set_step(cur_epoch * len(train_dataloader) + nb_tr_steps, "train")
                        log_writer.add_scalar('loss', train_loss)
                        log_writer.add_scalar('lr', scheduler.get_last_lr()[0])
                ...
                if (step + 1) % save_steps == 0 and args.do_eval:
                    ...
                    if args.data_num == -1:
                        log_writer.set_step(cur_epoch * len(train_dataloader) + nb_tr_steps, "dev")
